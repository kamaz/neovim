...
local mappings = {
  ...
  s = {
    ...
    d = { "<cmd>Telescope diagnostics<cr>", "[S]earch [d]iagnostic" },
    b = { "<cmd>Telescope git_branches<cr>", "[S]earch [b]ranch" },
    ...
    r = { "<cmd>Telescope oldfiles<cr>", "[S]earch Open [r]ecent File" },
    ...
    G = { "<cmd>Telescope gh gist<cr>", "[S]earch [G]ist" },
  },
